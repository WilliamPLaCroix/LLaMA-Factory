...
# rename gpus
source /nethome/wlacroix/LLaMA-Factory/experiments_sarubi/scripts/rename_gpus.sh
...
python3 scripts/vllm_infer_metrics.py --model_name_or_path "/scratch/wlacroix/.cache/llama_factory/wikilarge_grades_7_loss_merged" --save_path "/scratch/wlacroix/.cache/llama_factory/wikilarge_grades_7_loss_eval" --template llama3 --dataset wikilarge_grade_7_validate \
> experiments_sarubi/logs/infer_7_loss.log  2>&1
