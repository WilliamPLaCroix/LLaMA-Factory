...
python3 scripts/vllm_infer.py --help # --model_name_or_path "/scratch/wlacroix/.cache/llama_factory/wikilarge_grades_7_loss_model" --template llama3 --dataset wikilarge_grade_7_validate \
