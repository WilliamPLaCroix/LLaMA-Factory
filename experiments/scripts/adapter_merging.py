...
def main(model="/scratch/common_models/Llama-3.2-3B-Instruct", 
    ...
    model.add_weighted_adapter(adapters, weights, merge_method=merge_method, density=density, adapter_name=merged_adapter_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--adapters", nargs="+", help="List of adapter paths", default=None)
    parser.add_argument("--grades", nargs="+", help="List of adapter grades. len must match --adapters", default=None)
