...
python3 scripts/vllm_infer_metrics.py --model_name_or_path "/scratch/common_models/Llama-3.2-3B-Instruct" --adapter_name_or_path "/scratch/wlacroix/.cache/llama_factory/2_12_adapter/checkpoint-10820" --save_path "/scratch/wlacroix/.cache/llama_factory/2_12" --template llama3 --dataset wikilarge_grade_7_test --temperature 0 --grade 7 \
