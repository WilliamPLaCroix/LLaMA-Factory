...
python3 scripts/vllm_infer_metrics.py --model_name_or_path "/scratch/common_models/Llama-3.2-3B-Instruct" --adapter_name_or_path "/scratch/wlacroix/.cache/llama_factory/debug" --save_path "/scratch/wlacroix/.cache/llama_factory/debug" --template llama3 --dataset debug \
> experiments_sarubi/logs/debug_infer.log  2>&1
